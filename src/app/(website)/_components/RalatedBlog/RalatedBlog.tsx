...
type RelatedBlogsDataTypeProps = {
  relatedBlogs?: ContentDataTypeResponse[];
};

const RalatedBlog = ({ relatedBlogs }: RelatedBlogsDataTypeProps) => {
  console.log(relatedBlogs);
  return (
    <div className="container py-[30px] md:py-[50px] lg:py-[72px]">
      <h2 className="text-2xl md:text-[28px] lg:text-[32px] font-semibold tracking-[0%] text-[#131313] uppercase leading-[120%] foit-manrope pb-2">
        RELATED
      </h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-[24px] md:gap-[30px] lg:gap-[36px] capitalize">
        ...
        <div className="md:col-span-3 w-full flex flex-col md:flex-row items-center justify-center gap-4">
          <div className="w-full md:w-1/2">
            ...
            <h1 dangerouslySetInnerHTML={{ __html: relatedBlogs?.[0]?.heading || "" }} className="text-2xl md:text-[28px] lg:text-[32px] font-manrope font-bold leading-[120%] tracking-[0%] text-[#131313]"/>
            <p className="text-base font-semibold font-manrope leading-[120%] tracking-[0%] uppercase text-[#424242] mt-4 md:mt-5 lg:mt-6">
              Credits - {relatedBlogs?.[0]?.date || ""}
            </p>
            <div className="mt-4 md:mt-5 lg:mt-6">
              <Image
                src={relatedBlogs?.[0]?.image1 || relatedBlogs?.[0]?.imageLink || ""}
                alt="blog image"
                width={458}
                height={346}
          ...
          <div className="w-full md:w-1/2">
            ...
            <h1 dangerouslySetInnerHTML={{ __html: relatedBlogs?.[1]?.heading || "" }} className="text-2xl md:text-[28px] lg:text-[32px] font-manrope font-bold leading-[120%] tracking-[0%] text-[#131313]"/>
            <p className="text-base font-semibold font-manrope leading-[120%] tracking-[0%] uppercase text-[#424242] mt-4 md:mt-5 lg:mt-6">
              Credits - {relatedBlogs?.[1]?.date || ""}
            </p>
            <div className="mt-4 md:mt-5 lg:mt-6">
              <Image
                src={relatedBlogs?.[1]?.image1 || relatedBlogs?.[1]?.imageLink || ""}
                alt="blog image"
                width={458}
                height={346}
                className="w-full h-[346px] object-cover rounded-[8px]"
