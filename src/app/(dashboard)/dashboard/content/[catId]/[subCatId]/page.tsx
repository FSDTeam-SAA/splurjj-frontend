...
import type { ContentDashboardResponse, ContentItem } from "../../_components/ContentDataType"
    ...
    return (
      <div className="p-6">
        <div className="bg-red-50 border border-red-200 rounded-lg p-4">
          ...
          <Button
            onClick={() => queryClient.invalidateQueries({ queryKey: ["all-contents"] })}
            className="mt-3"
            variant="outline"
          >
            Try Again
  ...
  return (
    <div className="p-6">
      ...
      <div className="flex justify-between items-start mb-8">
        <div>
          <h1 className="text-3xl font-bold text-gray-800 dark:text-white mb-2">{categoryName} Lists</h1>
            ...
            <div className="mt-8 pb-[108px]">
              <div className="flex justify-between items-center">
                <p className="font-normal text-base text-gray-600 dark:text-gray-400">
                  Showing {(currentPage - 1) * data.per_page + 1} to {Math.min(currentPage * data.per_page, data.total)}{" "}
