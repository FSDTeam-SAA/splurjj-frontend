...
const Footer = () => {
  ...
  return (
    <div
      ...
      style={{ backgroundColor: footer?.bg_color || "#f8f9fa" }}
    >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-10 gap-5 pb-3 md:pb-4">
          ...
          <div className="lg:col-span-2">
            <div
              ...
              style={{ color: footer?.text_color || "#1a1a1a" }}
            >
              CATEGORIES
            </div>
            {categoriesLoading ? (
            ...
            <ul>
              {shopData.map((item) => (
                <li
                  ...
                  style={{ color: footer?.text_color || "#1a1a1a" }}
                >
                  <Link href={`/shop/${item.shop.toLowerCase()}`}>
                    {item.shop}
                  </Link>
                </li>
              ))}
              ...
              <ul>
                {otherData.map((item) => (
                  <li
                    ...
                    style={{ color: footer?.text_color || "#1a1a1a" }}
                  >
                    <Link href={`/pages/${item.other}`}>{item.other}</Link>
                  </li>
                ))}
              </ul>
            )}
              ...
              <ul>
                {aboutData.map((item) => (
                  <li
                    ...
                    style={{ color: footer?.text_color || "#1a1a1a" }}
                  >
                    <Link href={`/pages/${item.about}`}>{item.about}</Link>
                  </li>
                ))}
              </ul>
            )}
